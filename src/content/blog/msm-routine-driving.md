---
title: "Mirrors & the MSM Routine: DVSA Skill 8 Explained"
...
howTo:
  name: "How to apply the MSM (Mirror-Signal-Manoeuvre) routine"
  description: "A step-by-step guide to checking mirrors correctly before every manoeuvre on your driving test"
  steps:
    - name: "Check the interior mirror"
      text: "Glance at the interior mirror to get an overall picture of what is behind you — vehicles, distances, and speeds."
    - name: "Check the relevant door mirror"
      text: "For a right turn or overtake, check the right door mirror. For a left turn or passing cyclists, check the left door mirror."
    - name: "Decide on a signal"
      text: "Based on what you have seen in your mirrors, decide whether a signal is needed and when to give it."
    - name: "Carry out the manoeuvre"
...
|---------|----------------|---------|
| Checking mirrors but not acting on the information | Treating mirror checks as a box-ticking exercise | Ask yourself: "What did I see and does it change what I do?" |
| Forgetting to check the left mirror for cyclists | Left mirror feels less important than right | Add a "cyclists?" mental prompt every time you move left |
| Not checking mirrors when slowing or stopping | Focus shifts forward when braking | Include a mirror check as the first step whenever you touch the brake |
| Checking only once instead of interior + door | Rushing the routine | Verbalise the sequence quietly ("interior... right door...") until it is automatic |
| Not checking mirrors after a manoeuvre | Manoeuvre feels complete once it starts | Build in a post-manoeuvre glance to confirm everything is clear |
