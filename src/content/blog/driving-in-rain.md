...
howTo:
  name: "How to drive safely in rain and adverse weather"
  description: "A practical step-by-step approach to handling wet roads, fog, ice and other adverse conditions for UK learner drivers"
  steps:
    - name: "Increase your following distance in wet conditions"
      text: "In dry conditions the two-second rule applies. In rain, extend this to a minimum of four seconds. On ice or snow, increase to ten seconds or more, as stopping distances can be ten times greater than in dry conditions."
    - name: "Set your wipers to match the conditions"
      text: "Use intermittent wipers for light drizzle, the slow setting for moderate rain, and fast for heavy rain. Your screen must be clear at all times — blurred vision through a rain-streaked windscreen is a hazard you can control."
    - name: "Ease off gently if you aquaplane"
      text: "If the steering suddenly feels light and unresponsive, you are aquaplaning. Do not brake sharply or turn the wheel. Ease off the accelerator gently and hold the steering straight until the tyres regain grip."
    - name: "Use fog lights only when visibility drops below 100m"
      text: "Rear fog lights must be used when visibility falls below 100 metres. Turn them off as soon as conditions improve — leaving them on in clear conditions dazzles other drivers and is a minor fault on test."
    - name: "Reduce speed significantly on ice and in fog"
...
|---------|----------------|---------|
| Not increasing following distance in rain | Habit from dry-weather driving | Make it a habit to say "four seconds" when rain starts and check your gap |
| Wipers set too slow for conditions | Not noticing the screen is smearing | Check wiper effectiveness every time rain intensity changes |
| Leaving fog lights on after fog clears | Forgetting to turn them off | Make a habit of checking fog lights every time visibility improves noticeably |
| Braking hard when aquaplaning | Panic response | Practise the mantra: ease off, hold straight, wait for grip |
| Driving at normal speed in fog | Misjudging visibility distance | Test yourself — if you cannot read a number plate at 20m, visibility is poor |
