...
howTo:
  name: "How to complete the independent driving section of your test"
  description: "A step-by-step guide to handling the independent driving section confidently, whether following a sat nav or road signs"
  steps:
    - name: "Listen carefully to the examiner's briefing"
      text: "Before the independent driving section starts, the examiner will tell you whether you are following a sat nav or road signs. They will show you a diagram if using road signs. Listen fully before the car moves."
    - name: "Follow the sat nav while applying your own judgement"
      text: "The sat nav will give you directions but you remain responsible for safe driving. Always obey road laws — if the sat nav instructs you to turn where it is not safe or legal to do so, do not follow it."
    - name: "Stay calm if you take a wrong turn"
      text: "Going the wrong way does not fail your test. If you miss a junction, continue driving safely. The sat nav will recalculate. You will only fail if you make unsafe driving decisions — not for the navigation error itself."
    - name: "Ask for clarification when needed"
...
|---------|----------------|---------|
| Panicking after missing a junction | Misunderstanding that navigation errors fail tests | Remind yourself: wrong direction is fine, unsafe driving is not |
| Following the sat nav into an unsafe manoeuvre | Treating it as an authority rather than a guide | You are the driver. The sat nav advises; you decide |
| Neglecting mirrors while reading the sat nav | Cognitive load of navigation | Use sat nav audio so your eyes stay on the road |
| Braking sharply for a missed turn | Instinct to fix the navigation error immediately | Let the sat nav recalculate; continue smoothly |
| Not asking for clarification when genuinely lost | Worry it will look bad | Asking is a sign of good judgement — unsafe guessing is not |
