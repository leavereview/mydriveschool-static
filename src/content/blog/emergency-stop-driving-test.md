...
howTo:
  name: "How to Perform an Emergency Stop on Your Driving Test"
  description: "The correct technique for passing the emergency stop exercise on a UK driving test"
  steps:
    - name: "React immediately to the examiner's signal"
      text: "When the examiner says 'Stop!' and raises their hand, brake firmly without hesitation — do not check mirrors first."
    - name: "Apply firm braking pressure"
      text: "Press the footbrake firmly with your right foot. In ABS-equipped cars, apply maximum pressure and hold it — do not pump the pedal."
    - name: "Press the clutch down"
      text: "Press the clutch pedal immediately after the brake to prevent engine stall and to maintain full steering control."
    - name: "Keep the steering straight"
      text: "Grip the wheel firmly and keep steering straight. The ABS will manage any wheel lock automatically — trust it."
    - name: "Bring the car to a complete stop"
      text: "Maintain brake pressure until the car stops completely. Do not release the brake prematurely."
    - name: "Apply handbrake and select neutral"
      text: "Once stopped, apply the handbrake, select neutral, and check all mirrors before moving off when the examiner instructs."
---
...
1. The examiner will ask you to pull up on the left at a safe, quiet spot during your test
2. They'll explain: *"Shortly, I'll ask you to stop as if it's an emergency. When I do this [raises hand], stop as quickly and safely as you can. I'll make sure it's safe before I give the signal"*
3. You'll drive on, not knowing exactly when the signal is coming
4. The examiner will choose a straight, quiet road, check their mirrors, and raise their hand
5. You react immediately and stop
...
When the examiner raises their hand, move your right foot from the accelerator to the brake without hesitation. There's no need to check mirrors first — this is the one situation where you act first.

**Step 2: Brake firmly**
Press the brake pedal hard. With ABS, you want maximum braking force — push the pedal as far as it will go. Don't ease off.

**Step 3: Keep pressing**
You may feel the brake pedal pulsing or vibrating under your foot. This is the ABS cycling. **Keep your foot pressed down firmly.** The natural instinct is to ease off because it feels strange. Don't.

**Step 4: Keep both hands on the wheel**
Maintain steering control throughout. Both hands on the wheel, steering straight.

**Step 5: Clutch down just before stopping**
As the car slows to just above walking pace, press the clutch pedal down to disengage the engine. This prevents stalling. If you press it too early (say, at 20mph), you remove engine braking and extend your stopping distance.

**Step 6: Stop, apply handbrake, select neutral**
Once stopped, apply the handbrake and select neutral. Take a breath.

**Step 7: Observations before moving off**
Interior mirror, right mirror, right blind spot. Signal if needed. Move off when it's safe.
