...
howTo:
  name: "How to Navigate a Roundabout on Your UK Driving Test"
  description: "Step-by-step technique for approaching, navigating, and exiting roundabouts to DVSA test-ready standard"
  steps:
    - name: "Plan your approach"
      text: "Identify your exit number before reaching the roundabout. Choose left lane for exits 1-2, right lane for exits 3+. Check mirrors and reduce speed."
    - name: "Signal correctly on approach"
      text: "Signal right if taking the 3rd exit or beyond. No signal is needed for exits 1 or 2 unless road markings indicate otherwise."
    - name: "Give way to traffic on the roundabout"
      text: "At the give way line, yield to all traffic already on the roundabout coming from your right. Move off only when there is a safe gap."
    - name: "Navigate the roundabout"
      text: "Keep to your chosen lane throughout. Check mirrors frequently and observe traffic alongside you. Maintain smooth, controlled speed."
    - name: "Signal left before your exit"
      text: "As you pass the exit before yours, signal left and check your left mirror for cyclists or vehicles on your inside."
    - name: "Exit and settle"
      text: "Exit smoothly in your lane and cancel your signal. Check mirrors again after exiting and re-establish a safe following distance."
---
