...
howTo:
  name: "How to safely interact with cyclists, pedestrians, and other drivers"
  description: "Anticipate the behaviour of every road user around you, give them appropriate space and priority, and never force them to change their speed or direction."
  steps:
    - name: "Identify vulnerable road users early"
      text: "Scan ahead for cyclists, pedestrians, motorcyclists, and horses well before you reach them. The earlier you spot them, the more time you have to respond without rushing."
    - name: "Give appropriate space"
      text: "Pass cyclists with at least 1.5 metres of clearance, allow pedestrians to finish crossing before you proceed on turns, and pass horses wide and slowly."
    - name: "Check mirrors before every manoeuvre near others"
      text: "Always check your left mirror before turning left to confirm no cyclist has moved up your nearside, and your right mirror before moving out to overtake."
    - name: "Do not cause others to adjust"
...
|---------|----------------|---------|
| Turning across a cyclist on the nearside | Forgetting a final left-mirror check before the turn | Add a specific left-mirror check as the last step before every left turn |
| Cutting in front of pedestrians crossing on turns | Prioritising your own movement over theirs | If in doubt, wait — they always have priority once crossing has begun |
| Sitting in a lorry's blind spot at junctions | Positioning based on car-sized vehicles only | If you cannot see the driver's mirrors, they cannot see you — move back |
| Passing horses too close or accelerating past them | Treating them like a slow-moving vehicle | Drop to 10 mph, pass wide, wait before accelerating |
| Reacting sharply when another driver cuts in | Insufficient following distance | Maintain a gap that absorbs others' errors without emergency braking |
