...
skill_number: 14
imageAlt: "A learner driver approaching a T-junction carefully, checking both ways before emerging onto the main road during a driving lesson"
howTo:
  name: "How to Approach and Emerge from a T-Junction"
  description: "A step-by-step guide to the MSPSL routine for approaching and safely emerging from a T-junction to the standard required for the DVSA driving test."
  steps:
    - name: "Mirror check"
      text: "As soon as you identify the junction ahead, check your centre mirror and the mirror relevant to the direction you intend to turn. Know what is behind you before you change speed."
    - name: "Signal"
      text: "Signal in the direction you intend to turn in good time — early enough for following traffic and pedestrians to act on it, but not so early that it misleads drivers at a nearby junction."
    - name: "Position"
      text: "Move to the correct position for your intended turn. For a left turn, keep to the left. For a right turn, position just left of the centre line. Position before you reduce speed significantly."
    - name: "Speed"
      text: "Reduce your speed progressively to a speed appropriate for the junction — slow enough to stop if necessary, but not so slow that you block following traffic unnecessarily. Change down through the gears as needed."
    - name: "Look"
...
|---------|----------------|---------|
| Emerging without adequate observation | Rushing, or assuming it is clear because it looked clear earlier | Stop at every closed junction; look right, left, right before committing to emerge |
| Approaching too fast for the junction | Not identifying the junction early enough | Scan further ahead — junction signs, road markings, and gaps in buildings are early warnings |
| Wrong road position on approach | Not thinking about position until the last moment | Apply MSP (mirror, signal, position) well before you need to reduce speed |
| Stalling at a give way line | Applying brake while still in a high gear | Select an appropriate gear for the speed you plan to approach at — usually 2nd or 1st |
| Emerging into the path of an oncoming vehicle | Misjudging the speed or distance of approaching traffic | If you are not certain it is safe, wait. There will always be another gap. |
...
- [Roundabouts](/blog/roundabouts-driving-test) — DVSA Skill 15, where observation, signalling, and lane discipline combine in a more complex multi-lane environment
