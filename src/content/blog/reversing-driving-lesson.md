---
title: "Reversing: Master DVSA Skill 17 for Your Driving Test"
...
howTo:
  name: "How to Reverse Safely in a Straight Line"
  description: "A step-by-step method for reversing under control with full all-round observation, to the standard required for the DVSA driving test."
  steps:
    - name: "Prepare the car"
      text: "Apply the handbrake, select reverse gear, and carry out full all-round observations — mirrors and blind spots in every direction — before moving."
    - name: "Find your reference point"
      text: "Turn in your seat to look through the rear window. Identify a fixed reference point (a line on the rear window, or a point on the parcel shelf) to help you track a straight path."
    - name: "Move off slowly"
      text: "Release the handbrake and use clutch control to move at a slow walking pace. Avoid accelerating into reverse; controlled, minimal speed gives you time to react."
    - name: "Maintain continuous observation"
      text: "Keep looking through the rear window as your primary view, supplemented by regular checks of all mirrors and blind spots. Be ready to stop immediately for any road user."
    - name: "Steer to correct drift"
