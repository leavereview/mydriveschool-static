---
title: "Signalling on Your Driving Test: When and How (Skill 9)"
...
howTo:
  name: "How to signal correctly during your driving test"
  description: "A practical guide to timing, cancelling, and deciding when a signal is genuinely necessary"
  steps:
    - name: "Check your mirrors first"
      text: "Always complete your MSM mirror check before signalling. Signals come after mirrors, not before."
    - name: "Decide if a signal will benefit someone"
      text: "Only signal if there is another road user — driver, cyclist, or pedestrian — who will benefit from the information."
    - name: "Give the signal in good time"
      text: "Signal early enough to be useful but not so early that it becomes misleading, especially near multiple junctions."
    - name: "Cancel the signal after the manoeuvre"
