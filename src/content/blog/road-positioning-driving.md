---
title: "Road Positioning: DVSA Skill 7 — Lane Discipline Guide"
...
howTo:
  name: "How to Maintain Correct Road Position Throughout Your Drive"
  description: "A four-step approach to positioning your car correctly at all times — in normal driving, approaching turns, and on multi-lane roads."
  steps:
    - name: "Set your normal driving position"
      text: "On a two-way road, keep roughly 1 metre from parked cars and stay in the left half of your lane. Look well ahead to spot hazards early and maintain a straight line."
    - name: "Adjust position for left turns"
      text: "As you approach a left turn, move slightly to the left of your lane and check the left door mirror for cyclists who may be filtering alongside you."
    - name: "Adjust position for right turns"
      text: "For right turns, move to the right side of your lane (or the right-turn lane if available), without crossing the centre white line. Check the right mirror and signal in good time."
    - name: "Apply lane discipline on multi-lane roads"
      text: "On roads with two or more lanes in the same direction, keep to the left lane unless overtaking. Return to the left lane promptly after passing a vehicle."
---
