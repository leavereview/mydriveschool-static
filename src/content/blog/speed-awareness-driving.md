...
howTo:
  name: "How to manage speed appropriately for conditions"
  description: "Match your speed to the road environment, not just the posted limit, so you remain safe and in full control at all times."
  steps:
    - name: "Read the environment"
      text: "Before adjusting your speed, assess road width, visibility distance, weather conditions, and the presence of pedestrians or cyclists."
    - name: "Apply the limit as a ceiling"
      text: "Treat the speed limit as the maximum permitted speed, not the target. Choose a speed that gives you time to stop within the distance you can see to be clear."
    - name: "Accelerate and brake progressively"
      text: "Build up speed smoothly after hazards rather than rushing, and start braking early so deceleration is gradual — never harsh."
    - name: "Anticipate the need to slow down"
...
|---------|----------------|---------|
| Driving at 30 in a 40 zone | Anxiety about going "too fast" | Trust your observations — if the road is clear and dry, use the limit |
| Braking hard at junctions | Reading the road too late | Look further ahead and start easing off the accelerator earlier |
| Matching speed to traffic rather than conditions | Social pressure from cars behind | Your speed is your decision — examiners penalise being pushed |
| Constant speed through varying conditions | Treating the limit as the target | Ask yourself at every hazard: "Is my current speed appropriate?" |
| Rushing after a slow section | Overcompensating when road clears | Accelerate gradually and smoothly, not all at once |
