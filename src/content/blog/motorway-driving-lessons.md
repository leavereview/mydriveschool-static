...
howTo:
  name: "How to Drive Safely on a Motorway"
  description: "A five-step guide to motorway driving for learners — from joining at full speed to dealing with breakdowns and smart motorway signals."
  steps:
    - name: "Join at motorway speed using the full slip road"
      text: "Use the entire acceleration lane to build your speed to 60–70mph. Check mirrors and right blind spot, signal, and join when there is a safe gap. Give way to traffic already on the motorway."
    - name: "Stay in the left lane and use the 2-second rule"
      text: "Default position on a motorway is the left lane. Maintain at least a 2-second gap to the vehicle ahead — double it to 4 seconds in wet weather or poor visibility."
    - name: "Overtake using the MSM sequence"
      text: "Mirror, Signal, Manoeuvre — check interior mirror, right mirror, right blind spot, signal, move out, pass, check left mirror, signal left, return to left lane. Never undertake."
    - name: "Obey all overhead gantry signs immediately"
      text: "On smart motorways, gantry signs showing speed limits, lane closures, or red X symbols are legally enforceable. A red X means the lane is closed — you must not drive in it."
    - name: "Handle a breakdown safely"
      text: "If the car develops a problem, indicate left, move to the hard shoulder or emergency refuge area (ERA), switch on hazard lights, exit the vehicle from the left side, move behind the barrier, and call for help from the emergency phone or mobile."
---
...
|---------|----------------|---------|
| Joining too slowly | Fear of speed, braking on the slip road | Build speed continuously from the moment you enter the slip road; commit to the process |
| Middle-lane hogging | Uncertainty about when to return to the left | Rule of thumb: if the left lane alongside you is clear, move back into it now |
| Following too closely | 70mph gaps look large enough when they are not | Use the 2-second phrase-check at every opportunity until it becomes habitual |
| Ignoring gantry signs | Focusing on the traffic ahead rather than overhead | Practise scanning gantry signs as part of your forward-looking routine |
| Undertaking on the left | Frustration with middle-lane hogging ahead | Signal and overtake on the right correctly; never pass on the left in a moving lane |
