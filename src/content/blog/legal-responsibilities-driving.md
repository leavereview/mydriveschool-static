...
howTo:
  name: "How to understand and apply your legal responsibilities as a driver"
  description: "A clear guide to the legal requirements every UK learner driver must know before getting behind the wheel"
  steps:
    - name: "Ensure your provisional licence is valid and with you"
      text: "You must hold a valid UK provisional driving licence to drive on public roads. Carry it with you every time you drive. You must also display L plates (red L on white background) on the front and rear of the vehicle."
    - name: "Confirm the vehicle is insured for you to drive"
      text: "You must be named as a driver on a valid insurance policy before driving. Learners typically use either a dedicated learner driver policy or are added to a parent or instructor's policy. Driving uninsured carries a fixed penalty, points, and possible disqualification."
    - name: "Check the vehicle has a valid MOT and road tax"
      text: "Any vehicle over three years old requires an annual MOT certificate. Road tax (Vehicle Excise Duty) must also be paid. Both can be checked online using the DVLA's free vehicle enquiry service — search the registration plate at gov.uk."
    - name: "Understand the new driver rules that apply after you pass"
...
Legal responsibilities are the foundation of everything else in driving. Before you learn to steer, before you understand junctions, before you practise parallel parking — you must understand what it means to be a legally compliant driver on UK roads. DVSA Skill 1 is the starting point of the [DVSA 27 driving skills framework](/dvsa-27-driving-skills/) and the [basics skills group](/driving-skills/basics/) deliberately: a driver who understands their obligations is a more responsible driver, not just a more legal one.
...
**Insurance**: At minimum, any vehicle you drive must have third-party insurance. Learner driver insurance policies are widely available — either as standalone policies or as short-term additions to an existing policy (often a parent's). Your instructor's [driving school insurance](/blog/driving-school-insurance-guide/) covers the training vehicle separately. Driving without insurance is a serious offence: six penalty points, a fine of up to £5,000, and possible disqualification.
