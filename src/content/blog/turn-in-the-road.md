---
title: "Turn in the Road: 3-Point Turn Guide for Driving Test"
...
howTo:
  name: "How to Turn in the Road (3-Point Turn)"
  description: "A step-by-step guide to completing a turn in the road safely and accurately on a narrow road, meeting DVSA test standard."
  steps:
    - name: "Signal and position"
      text: "Pull up on the left side of the road in a safe, suitable location. Apply the handbrake. Check all around for traffic, pedestrians, and parked vehicles before beginning."
    - name: "First forward move"
      text: "Move off slowly with full right lock applied, crossing to the other side of the road. Keep your speed very slow using clutch control. Stop before the opposite kerb, applying the handbrake."
    - name: "First reverse move"
      text: "Check all around thoroughly. Select reverse, apply full left lock, and reverse slowly across the road. Look through the rear window and continue checking all mirrors and blind spots. Stop before the kerb behind you."
    - name: "Final forward move"
      text: "Check all around again. Select first gear and steer to the left to complete the turn, driving away in the opposite direction from your starting position."
    - name: "Complete the manoeuvre"
      text: "Drive away at a safe speed, rejoining normal traffic flow. If more than three moves are needed, complete them calmly — additional moves are not automatically a test failure."
    - name: "All-round observation throughout"
...
|---------|----------------|---------|
| Touching or mounting the kerb | Moving too fast, or not stopping early enough | Use the clutch to keep speed very slow; stop when the kerb appears at the base of your windscreen |
| Rushing between moves | Nerves or desire to clear the road quickly | Take a full breath between each move; complete observations before selecting the next gear |
| Failing to observe before each move | Concentration narrows to the physical task | Build a verbal habit: say "checking mirrors, checking right, checking left" before each move |
| Needing more than three moves | Not applying full steering lock on each move | Apply full lock before you start moving on each phase, not after you are already rolling |
| Stopping too far from the kerb | Fear of getting too close | Practise judging the kerb distance; getting close (without touching) is efficient use of space |
