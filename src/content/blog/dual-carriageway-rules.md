...
howTo:
  name: "How to Join and Leave a Dual Carriageway Safely"
  description: "The five-step process for safely entering and exiting a dual carriageway, including speed matching, mirror checks, lane discipline, and using the deceleration lane correctly."
  steps:
    - name: "Approach the slip road and assess the traffic"
      text: "As you enter the slip road, check your mirrors and begin assessing the speed and gaps in the left lane of the dual carriageway. You need to match their speed before joining, not slow them down."
    - name: "Accelerate to match dual carriageway speed"
      text: "Use the full length of the acceleration lane to build your speed. For a 70mph dual carriageway, aim to be at 60–65mph before the give-way line. Signal right to show your intention to join."
    - name: "Check mirrors and blind spot before joining"
      text: "Check the interior mirror, right door mirror, and your right blind spot. If there is a clear gap, join smoothly. If traffic is close, adjust your speed to slot in behind it — do not force your way in."
    - name: "Maintain lane discipline while travelling"
      text: "Stay in the left lane. Move to the right lane only to overtake, using the MSM (Mirror, Signal, Manoeuvre) routine. Return to the left lane promptly once you have passed the vehicle ahead."
    - name: "Signal and move to the deceleration lane well before your exit"
      text: "Check mirrors, signal left, and move into the deceleration lane at the countdown markers. Reduce your speed in the deceleration lane, not before entering it. Match the speed required for the road you are joining."
---
...
|---------|----------------|---------|
| Joining at too low a speed | Fear of high-speed traffic; braking on the slip road | Trust the acceleration lane; practise building to 60mph+ on the slip road with instructor guidance |
| Staying in the right lane after overtaking | Not noticing the left lane is clear; laziness | Make returning to the left lane part of the MSM routine — signal left as soon as you complete the pass |
| Braking before the deceleration lane | Wanting to slow down gradually from a long distance | Maintain speed until you reach the countdown markers, then use the deceleration lane for braking |
| Forgetting the blind spot before moving right | Rushed MSM sequence | Verbalise the sequence: "mirror, mirror, blind spot" before every lane change |
| Panic-stopping on the slip road | Low speed and a gap disappears | If a gap closes, adjust speed slightly to find the next gap — keep moving forward |
