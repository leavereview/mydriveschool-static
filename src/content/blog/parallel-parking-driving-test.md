...
howTo:
  name: "How to Parallel Park for Your UK Driving Test"
  description: "Step-by-step technique for performing a parallel park to DVSA test-ready standard"
  steps:
    - name: "Pull alongside the reference car"
      text: "Position your car parallel to and about 1 metre from the parked car, with the rear of your car level with the rear of the reference car."
    - name: "Reverse straight back"
      text: "Check all mirrors and blind spots, then reverse slowly in a straight line until your rear bumper aligns with the reference car's rear bumper."
    - name: "Steer left to first reference point"
      text: "Apply full-lock left and reverse until you can see the kerb reflected in your left door mirror — this is your first reference point."
    - name: "Straighten and continue reversing"
      text: "Straighten the wheel and continue reversing slowly until the front of your car clears the reference car."
    - name: "Steer right to straighten up"
      text: "Apply full-lock right and reverse until your car is parallel to the kerb, approximately 30cm away."
    - name: "Adjust and complete"
      text: "Straighten the wheel and reverse to a safe distance behind the reference car, then apply the handbrake and select neutral."
---
