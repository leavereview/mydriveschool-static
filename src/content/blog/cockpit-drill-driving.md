...
category: "The Basics"
skill_number: 3
imageAlt: "Driver adjusting car mirrors before driving — cockpit drill"
howTo:
  name: "How to perform the cockpit drill before driving"
  description: "The complete step-by-step DSSSM cockpit drill every UK driver should complete before moving the car"
  steps:
    - name: "Doors — check all are fully closed"
      text: "Before adjusting anything else, check all doors are closed properly. An open or ajar door is a safety hazard, a distraction, and in some vehicles will trigger a dashboard warning that prevents the engine starting. Check visually and listen for the click."
    - name: "Seat — adjust for correct position"
      text: "Your seat should be positioned so both arms are slightly bent when holding the steering wheel at the 9 and 3 position. Your right foot should reach the accelerator fully with your leg slightly bent at the knee. You should be able to press the clutch fully to the floor without fully straightening your leg."
    - name: "Steering — adjust column if available"
      text: "If the vehicle has an adjustable steering column, set height and reach so the wheel is comfortable and does not obstruct your view of the dashboard instruments. The steering wheel should not feel stretched to reach."
    - name: "Seatbelt — fasten yours, check passengers"
      text: "Fasten your own seatbelt first, then confirm all passengers have theirs. You are legally responsible for ensuring passengers under 14 are properly restrained. An unfastened seatbelt during your test is a serious fault."
    - name: "Mirrors — adjust all three before starting"
