...
skill_number: 10
imageAlt: "View from the driver's seat looking ahead down a busy UK road with parked vehicles and a junction ahead"
howTo:
  name: "How to develop anticipation and planning ahead while driving"
  description: "A structured approach to scanning further ahead, identifying hazards early, and adjusting your driving before problems develop"
  steps:
    - name: "Look 12 seconds ahead"
      text: "Train your eyes to scan the road 12 seconds ahead of your current position — roughly 4 car lengths at 30mph, much further at higher speeds."
    - name: "Identify hazards by type"
      text: "Categorise what you see as static hazards (parked cars, junctions, bends) or dynamic hazards (pedestrians, emerging vehicles, cyclists). Each needs a different response."
    - name: "Plan your response early"
      text: "Once a hazard is identified, decide your response — reduce speed, change position, cover the brake — before the hazard develops into a crisis."
    - name: "Always maintain an escape route"
...
|---------|----------------|---------|
| Following too close | New drivers feel safer close to the vehicle ahead | Increase gap to 2 seconds minimum; the gap is your reaction time |
| Only watching the vehicle directly ahead | Tunnel vision, especially in heavy traffic | Consciously lift your gaze to the vehicle two ahead, or to the horizon on open roads |
| Braking late at junctions | Noticing the junction but not responding until close | Identify the junction the moment you can see it and begin gentle deceleration immediately |
| Ignoring pedestrians until they step out | Focusing on vehicle traffic only | Scan pavements and islands as well as the carriageway |
| Not covering the brake near hazards | Overconfidence or complacency | "Covering the brake" (foot hovering, not pressing) should be automatic near parked vehicles and junctions |
