---
title: "Bay Parking on Your Driving Test: Forward and Reverse"
...
howTo:
  name: "How to Reverse Bay Park for Your Driving Test"
  description: "A step-by-step guide to completing a reverse bay park accurately and safely, meeting DVSA test standard."
  steps:
    - name: "Choose your target bay"
      text: "Select a bay and position your car parallel to the row of bays, roughly one bay's width away from the line marking the bay you intend to use."
    - name: "Identify your reference point"
      text: "As you draw level with the line of your chosen bay, look in your mirrors to find the reference point where your car aligns with the bay markings."
    - name: "Begin reversing slowly"
      text: "Apply full lock in the direction of the bay, reversing at a slow, controlled speed using clutch control. Keep checking all mirrors and blind spots throughout."
    - name: "Straighten up"
      text: "As the bay lines appear parallel on both sides in your mirrors, steer to straighten the wheel and guide the car centrally into the bay."
    - name: "Check your position"
      text: "Once straight, verify you are within the bay lines and not overhanging any adjacent bays. Apply the handbrake and select neutral."
    - name: "Report to the examiner"
...
|---------|----------------|---------|
| Finishing with wheels on the bay line | Reference point used too early or too late | Practice identifying your specific reference point for your car's geometry |
| Not checking mirrors and blind spots | Focus narrows onto the bay markings | Build a habit: check before you move and every few seconds throughout |
| Finishing at an angle | Straightening the wheel too early or too late | Keep checking both side mirrors simultaneously to judge when lines are parallel |
| Moving too fast | Nerves or impatience | Remind yourself that slow speed is a feature, not a fault |
| Stopping short of the bay or overhanging the rear | Misjudging the car's length | Use a rearward reference point (e.g., bay line visible in rear window) to judge depth |
