...
skill_number: 10
imageAlt: "A learner driver scanning the road ahead through a windscreen, mirrors visible, approaching a junction with clear observation technique"
howTo:
  name: "How to Apply Effective Observation on Your Driving Test"
  description: "A step-by-step guide to scanning, anticipating hazards, and reading the road to the standard required by DVSA examiners."
  steps:
    - name: "Scan far ahead, not just immediately in front"
      text: "Train your eyes to look 10-12 seconds ahead on open roads. This gives you time to identify developing hazards before they require action."
    - name: "Check mirrors before every action"
      text: "Use the MSM routine — Mirrors, Signal, Manoeuvre — before signalling, changing speed, or changing position. Make mirror checks obvious and deliberate."
    - name: "Identify potential hazards early"
      text: "Look for parked vehicles, pedestrians stepping out, cyclists in your path, vehicles at junctions, and changes in road conditions. Name them mentally as you see them."
    - name: "Reduce speed in response to hazard potential"
      text: "When a hazard is developing, reduce speed before it becomes critical. Arriving at a junction slowly gives you time to observe and react; arriving fast forces a snap decision."
    - name: "Respond to what you see, not what you expect"
      text: "Anticipation means reacting to actual clues — a pedestrian stepping toward the kerb, a vehicle nose appearing at a junction — not assuming everything will be fine."
---
...
| Observation Clue | Anticipated Risk | Correct Response |
|-----------------|-----------------|-----------------|
| Parked ice cream van with children nearby | Child runs into road | Reduce speed, cover brake, be ready to stop |
| Vehicle stationary at junction, wheels turning | Driver about to pull out | Reduce speed, cover brake, be prepared to give way |
| Large vehicle approaching on narrow road | Insufficient width to pass safely | Slow down and identify a passing place |
| Ball rolls across road ahead | Child following behind it | Brake and prepare to stop |
| Cyclist ahead looking over their right shoulder | Cyclist about to move right | Check mirrors, ease back, give space |
| Pedestrian standing at zebra crossing, looking across | Pedestrian about to step out | Slow down and prepare to stop — you must give way |
