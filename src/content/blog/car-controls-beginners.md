...
howTo:
  name: "How to Learn and Master the Basic Car Controls"
  description: "A step-by-step approach to understanding every control in the car before you begin moving, covering pedals, gears, steering, and secondary controls."
  steps:
    - name: "Adjust your seating position"
      text: "Sit so you can press the clutch fully to the floor with a slight bend in your knee. Check mirror reach and steering wheel distance — you should hold the wheel with bent elbows, not straight arms."
    - name: "Identify and name every pedal"
      text: "From left to right: clutch (left foot only), brake (right foot), accelerator (right foot). Press each one gently in a stationary car to feel the resistance before the engine is started."
    - name: "Walk through the gear positions"
      text: "With the engine off, move through all gears and reverse using the gear diagram on the gear knob. Feel the gate — the natural path the stick wants to follow between gears."
    - name: "Locate every secondary control"
      text: "Identify indicators, lights, wipers, horn, and hazard lights. Practice switching wipers on and off, dipping headlights, and sounding the horn while stationary."
    - name: "Read every warning light on the dashboard"
...
|---------|----------------|---------|
| Riding the clutch | Nervousness, unsure when to lift it | Consciously remove foot from clutch once moving; rest it on the floor |
| Looking down when changing gear | Not confident about gear positions yet | Practice gear positions with engine off until muscle memory develops |
| Gripping steering wheel too tightly | Anxiety or overcompensating for wobble | Consciously relax grip; imagine holding a piece of paper without folding it |
| Using both feet on the brake | Previous automatic car experience | Verbal reminder: left foot is clutch only; park it left of the pedals |
| Coasting in neutral | Trying to save fuel or simplify control | Stay in gear until just before stopping; this gives engine braking and control |
