...
howTo:
  name: "How to drive responsibly with passengers and loads"
  description: "Step-by-step guidance for managing passengers and vehicle loading safely during your UK driving test and beyond"
  steps:
    - name: "Brief passengers before you move"
      text: "Before starting the engine, ask all passengers to put on their seatbelts, keep conversation calm, and avoid anything that would distract the driver. You are legally responsible for passengers under 14 wearing seatbelts."
    - name: "Check seatbelts and loading before every journey"
      text: "Walk around the vehicle if you are carrying a load. Check that nothing is obscuring your mirrors or rear window, that roof loads are secure, and that tyre pressures are appropriate for the additional weight."
    - name: "Manage peer pressure actively"
      text: "As the driver, you have sole legal responsibility for the vehicle regardless of what passengers say or ask. If a passenger pressures you to speed, take risks, or use your phone, you are entitled and required to refuse."
    - name: "Adjust your driving for additional weight"
...
|---------|----------------|---------|
| Being distracted by passengers | Natural social instinct | Brief passengers before moving; practise keeping conversation short while driving |
| Not checking all seatbelts | Assuming passengers have sorted themselves | Make a seatbelt check part of your cockpit drill every single time |
| Not adjusting following distance for load | Not thinking about vehicle physics | Remind yourself: more weight = more stopping distance needed |
| Responding to peer pressure | Wanting to appear confident | Internalise that refusing to speed IS confident behaviour |
| Using mirrors obscured by rear passengers or loads | Not noticing until on the road | Check all three mirrors are clear as part of your loading check |
