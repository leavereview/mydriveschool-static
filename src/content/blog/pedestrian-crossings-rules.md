---
title: "Pedestrian Crossings: Rules & Driving Test Guide (Skill 16)"
...
howTo:
  name: "How to Approach and Stop at a Pedestrian Crossing Correctly"
  description: "A step-by-step guide to handling all pedestrian crossing types safely and legally, to the standard required for the DVSA driving test."
  steps:
    - name: "Identify the crossing early"
      text: "Look for warning signs (zigzag lines, diamond warning signs, flashing beacons) as early as possible. The earlier you identify the crossing type, the more time you have to respond correctly."
    - name: "Check your mirrors"
      text: "Check the centre mirror and the mirrors relevant to any lane change required. Know what is behind you before you reduce your speed."
    - name: "Reduce speed progressively"
      text: "Begin slowing early and smoothly. Late, harsh braking approaching a crossing is a fault in itself and dangerous to following traffic. Approach at a speed from which you can stop comfortably."
    - name: "Be prepared to stop"
      text: "For signal-controlled crossings, stop at the stop line if the signal shows red or amber. For zebra crossings, give way to any pedestrian who is on the crossing or has started to step onto it."
    - name: "Wait until the crossing is clear"
...
|---------|----------------|---------|
| Not slowing early enough on approach | Failing to spot the crossing signs or zigzag lines in advance | Scan further ahead; zigzag markings and Belisha beacons are visible from well back |
| Creeping forward while a pedestrian crosses | Impatience, or trying to be ready to move off quickly | Once stopped, keep the car stationary until the pedestrian is fully clear of the crossing |
| Stopping past the stop line | Approaching too fast and overshooting | Reduce speed earlier; the stop line is where your vehicle must be — tyres, not bumper |
| Not giving way at a Pelican crossing on flashing amber | Misunderstanding the rule | Check if anyone is on the crossing; if so, wait. If clear, you may proceed. |
| Failing to check mirrors before slowing | Habitual omission under pressure | Use the MSM routine (mirrors, signal, manoeuvre) on every approach to every crossing |
...
- [Roundabouts](/blog/roundabout-rules-uk/) — DVSA Skill 15, another complex priority situation where lane discipline and observation combine
