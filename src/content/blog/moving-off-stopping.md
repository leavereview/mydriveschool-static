...
tags: ["control-positioning", "dvsa-skills"]
...
howTo:
  name: "How to Move Off and Stop Safely"
  description: "The complete POM routine for moving off and a systematic approach to stopping safely at the right position, including hill starts."
  steps:
    - name: "Prepare the car"
      text: "Select first gear, find the bite point with the clutch, and set a gentle amount of gas on the accelerator — enough that the engine hums rather than sits at idle."
    - name: "Observe all around"
      text: "Check the interior mirror, right door mirror, then look over your right shoulder (blind spot check). If clear, check ahead and left as well before committing to move."
    - name: "Move off smoothly"
      text: "If signalling is needed, apply the indicator, then release the handbrake and bring the clutch up gently to let the car roll forward. Increase gas progressively as you pull away."
    - name: "Choose a safe stopping position"
      text: "When stopping, identify a legal, safe position well in advance — not on zigzag lines, double yellow lines, or opposite a junction. Signal left if pulling over from moving traffic."
    - name: "Stop smoothly and secure the car"
      text: "Check mirrors, reduce gas, apply the brake progressively, press the clutch as you slow below 10mph, stop, apply handbrake, select neutral."
---
...
|---------|----------------|---------|
| Moving without a blind spot check | Rushing or forgetting the full sequence | Use a mantra: "Mirror, mirror, blind spot" every single time |
| Stalling when moving off | Releasing the clutch too quickly or too little gas | Hold the bite point longer; add gas before releasing handbrake |
| Stopping too close to a parked vehicle | Focusing on the kerb, not the full picture | Look for gaps in parked cars well in advance and plan a stop |
| Stopping on yellow lines or zigzags | Not spotting road markings in time | Scan ahead 50–100 metres for restrictions whenever pulling over |
| Rolling back on a hill start | Not enough gas, or handbrake released too early | Find bite point first, add gas until engine note changes, then handbrake |
