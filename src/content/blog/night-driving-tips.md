...
howTo:
  name: "How to drive safely in the dark"
  description: "A step-by-step approach to night driving for UK learner drivers preparing for their test"
  steps:
    - name: "Set your headlights correctly from dusk"
      text: "Switch to dipped headlights as soon as natural light starts to fade — not just when it is fully dark. This is a legal requirement and examiners will notice if you delay."
    - name: "Use full beam on unlit roads"
      text: "On unlit rural roads with no oncoming traffic within 100m and no vehicles ahead, switch to full beam. This significantly extends your visible range and reduces the risk of hitting unseen hazards."
    - name: "Return to dipped beam for oncoming traffic"
      text: "As soon as you see oncoming headlights, return to dipped beam immediately. Failing to do so causes dangerous glare and is an automatic serious fault on test."
    - name: "Adjust speed to match your headlight range"
...
- [Use of Speed: DVSA Skill 11](/blog/speed-awareness-driving/) — understanding appropriate speed is inseparable from night driving safety
